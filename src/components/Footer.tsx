...
export default function footer() {
    return (
        <footer className="footer-component flex flex-col gap-20 text-bone-50 bg-bark-950 w-full overflow-hidden">
            ...
            <div className="flex flex-col gap-8">
                ...
                <p className="display display-mega text-center whitespace-nowrap select-none -mb-[0.18em]">WoodWork</p>
            </div>
        </footer>
    )
}
