        ...
        <div id="cart" className={`flex justify-end items-center gap-5 ${spacingStyle} absolute w-full`}>
            <DialogTrigger>
                ...
                <Modal className=" z-2 text-white flex justify-center items-center fixed left-[50%] top-[50%] translate-[-50%] backdrop-blur-sm w-full h-full p-10 font-roboto">
                    <Dialog className="modal-pop-up flex flex-col justify-between bg-black drop-shadow-xl/50 h-200 w-180 p-10 max-lg:h-170">
                            ...
                            <div className={`flex justify-between max-lg:flex-col max-lg:items-center max-lg:gap-5 ${inCart === 0 ? 'hidden aria-hidden' : 'block'} `}>
                                ...
                                <div>
                                    <div className="text-black flex gap-4 max-lg:justify-center max-lg:w-40">
                                        <button onClick={() => handleCartDecrement(inCart)} className="hover:cursor-pointer"><svg className="fill-white w-5" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M1 10L1 6L15 6V10L1 10Z"></path> </g></svg></button>
                                        <div className="flex justify-center items-center bg-white pl-4 pr-4 select-none w-10">{inCart}</div>
                                        <button onClick={() => handleCartIncrement(inCart)} className="hover:cursor-pointer"><svg className="fill-white w-5" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M10 1H6V6L1 6V10H6V15H10V10H15V6L10 6V1Z"></path> </g></svg></button>
                                    </div>
                                </div>
                            </div>
                        </div>
