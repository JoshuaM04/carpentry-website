    ...
    return (
        <div className="about-container flex flex-col gap-20">
            <main className="flex min-h-dvh p-10">
                <div className="flex flex-col justify-center gap-5 w-full p-5 mt-40 max-2md:mt-60"> 
