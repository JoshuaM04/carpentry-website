            ...
            <div className="flex flex-col gap-10 mt-40">
                <div className="grid grid-cols-[1fr_400px] gap-10 max-2md:flex max-2md:flex-col">
                    ...
                    <div className="product-information-container flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-5 bg-slate-100 p-2 -mt-2">
                            <div className="flex justify-between">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="bg-white pl-4 pr-4 select-none">{quantity}</div>
                            ...
                            <button className="font-semibold text-white bg-black p-2 -ml-2 -mr-2 -mb-2 hover:cursor-pointer">Add to cart</button>
                        </div>
                    </div>
                </div>
            </div>
