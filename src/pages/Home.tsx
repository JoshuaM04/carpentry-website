        ...
        <div className="home-container flex flex-col gap-20">
            <main className="flex flex-col gap-20 items-center">
                <section id="video-showcase" className="relative h-screen w-full overflow-hidden">
                    ...
                    <div className="h-screen w-full overflow-hidden mt-30 pointer-events-none"><img className="top-0 left-0 w-full h-full object-cover" src="/heroSectionImage.avif" alt="WoodWork Creations banner" /></div>
                ...
                <section id="furniture-menu" className="flex flex-col gap-10 w-full p-10 pt-40">
                    ...
                    <div className="flex flex-wrap items-center gap-10 max-xsm:justify-center">
                        <div className="flex justify-center items-center text-xl uppercase font-bold text-white bg-black size-60">
                            Coming Soon
                        </div> 
                    </div>
                </section>
