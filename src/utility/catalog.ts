...
export const FURNITURE_CATALOG: Product[] = [
    {
        ...
        stripePriceId: 'N/A',
        image: '/furniture/catalog/tables/earth-wood-gallery/earth-wood-front.png',
        imageGallery: ['/furniture/catalog/tables/earth-wood-gallery/earth-wood-front.png', '/furniture/catalog/tables/earth-wood-gallery/earth-wood-side.png', '/furniture/catalog/tables/earth-wood-gallery/earth-wood-top.png'],
        wood: 'Oak',
        width: '36"',
        height: '25"',
        diameter: '14"'
